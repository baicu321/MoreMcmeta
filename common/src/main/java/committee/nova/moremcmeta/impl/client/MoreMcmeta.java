...
package committee.nova.moremcmeta.impl.client;
...
import committee.nova.moremcmeta.api.client.ConflictingPluginsException;
import committee.nova.moremcmeta.api.client.InvalidPluginException;
...
import committee.nova.moremcmeta.api.client.metadata.MetadataRegistry;
import committee.nova.moremcmeta.impl.client.adapter.AtlasAdapter;
import committee.nova.moremcmeta.impl.client.adapter.NativeImageAdapter;
import committee.nova.moremcmeta.impl.client.adapter.PackResourcesAdapter;
import committee.nova.moremcmeta.impl.client.adapter.RootResourcesAdapter;
import committee.nova.moremcmeta.impl.client.adapter.TextureManagerAdapter;
import committee.nova.moremcmeta.impl.client.io.TextureData;
import committee.nova.moremcmeta.impl.client.io.TextureDataAssembler;
import committee.nova.moremcmeta.impl.client.io.TextureDataReader;
import committee.nova.moremcmeta.impl.client.mixinaccess.LocatableSpriteAtlas;
import committee.nova.moremcmeta.impl.client.resource.MetadataRegistryImpl;
import committee.nova.moremcmeta.impl.client.resource.ModRepositorySource;
import committee.nova.moremcmeta.impl.client.resource.OrderedResourceRepository;
import committee.nova.moremcmeta.impl.client.resource.ResourceCollection;
import committee.nova.moremcmeta.impl.client.resource.SpriteFrameSizeFixPack;
import committee.nova.moremcmeta.impl.client.resource.StagedResourceReloadListener;
import committee.nova.moremcmeta.impl.client.resource.TextureCache;
import committee.nova.moremcmeta.impl.client.resource.TextureLoader;
import committee.nova.moremcmeta.impl.client.texture.BaseCollection;
import committee.nova.moremcmeta.impl.client.texture.EventDrivenTexture;
import committee.nova.moremcmeta.impl.client.texture.AtlasFinder;
...
import committee.nova.moremcmeta.impl.client.texture.UploadComponent;
...
public abstract class MoreMcmeta {
            ...
            ModRepositorySource source = new ModRepositorySource(
                    new Pack.ResourcesSupplier() {
                        ...
                        public @NotNull PackResources openPrimary(PackLocationInfo packId) {
                            ...
                            ResourceLocation packIcon = ResourceLocation.fromNamespaceAndPath(MODID, "pack.png");
    ...
    private class TextureResourceReloadListener
        ...
        public CompletableFuture<Void> reload(
            ...
            return this.load(resourceManager, backgroundExecutor)
                    .thenCompose(barrier::wait)
                    .thenCompose(data -> this.apply(data, resourceManager, gameExecutor));
        }
    }
